...
var MatTableDataSource = class extends DataSource {
  ...
  constructor(initialData = []) {
    super();
    this._renderData = new import_rxjs9.BehaviorSubject([]);
    this._filter = new import_rxjs9.BehaviorSubject("");
    this._internalPageChanges = new import_rxjs9.Subject();
    ...
    this.filterPredicate = (data, filter4) => {
